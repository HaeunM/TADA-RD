...
- `n_case`, `n_control`: number of individuals **in your case–control dataset** corresponding to the variant-level files you provide (or the simulator output). These parameters are used **only in the TADA-CC component**, specifically in the case–control Bayes factor.
